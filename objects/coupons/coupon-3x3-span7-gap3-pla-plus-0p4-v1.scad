//////////////////////////////////////////////////////////////////////
// LibFile: coupon-3x3-span7-gap3-pla-plus-0p4-v1.scad
// Project: Grid Stack
// FileGroup: Immutable Structural Coupon
// FileSummary: 3 x 3 PLA+ coupon with 7 mm clear XY spans and 3 mm
...
saved_coupon = structural_coupon_object(
    name = "COUPON_3X3_SPAN7_GAP3_PLA_PLUS_0P4_V1",
    revision = 1,
