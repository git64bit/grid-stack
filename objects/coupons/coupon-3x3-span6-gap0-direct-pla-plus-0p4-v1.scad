//////////////////////////////////////////////////////////////////////
// LibFile: coupon-3x3-span6-gap0-direct-pla-plus-0p4-v1.scad
// Project: Grid Stack
// FileGroup: Immutable Structural Coupon
// FileSummary: 3 x 3 PLA+ coupon with 6 mm clear XY spans and 0 mm
//              clear vertical gap using direct_orthogonal geometry.
...
saved_coupon = structural_coupon_object(
    name = "COUPON_3X3_SPAN6_GAP0_DIRECT_PLA_PLUS_0P4_V1",
    revision = 1,
    ...
    lead_in = 30,
    support_strategy = "direct_orthogonal",
    status = "printed_reference",
    notes = "Geometry matches the physically accepted direct-contact coupon at commit 06f7cdd."
);
