//////////////////////////////////////////////////////////////////////
// LibFile: coupon-3x3-span6-gap2-pla-plus-0p4-v1.scad
// Project: Grid Stack
// FileGroup: Immutable Structural Coupon
// FileSummary: 3 x 3 PLA+ coupon with 6 mm clear XY spans and 2 mm
...
saved_coupon = structural_coupon_object(
    name = "COUPON_3X3_SPAN6_GAP2_PLA_PLUS_0P4_V1",
    revision = 1,
